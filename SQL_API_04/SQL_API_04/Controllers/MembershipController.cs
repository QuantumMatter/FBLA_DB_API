...
namespace SQL_API_04.Controllers
{
    public class MembershipController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,UserID,Group,Role")] Membership membership)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,UserID,Group,Role")] Membership membership)
        {
            if (ModelState.IsValid)
            {
