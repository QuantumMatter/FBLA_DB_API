...
namespace SQL_API_04.Controllers
{
    public class ConnectionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,UserID,ConnectionID")] Connection connection)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,UserID,ConnectionID")] Connection connection)
        {
            if (ModelState.IsValid)
            {
